...
- [[#1. JVM Architecture Overview|1. JVM Architecture Overview]]
	- [[#1. JVM Architecture Overview#JVM Components Summary|JVM Components Summary]]
	- [[#1. JVM Architecture Overview#Class Loading Phases|Class Loading Phases]]
- [[#2. Java Memory Areas|2. Java Memory Areas]]
	- [[#2. Java Memory Areas#2.1 Heap Memory|2.1 Heap Memory]]
	- [[#2. Java Memory Areas#2.2 Stack Memory|2.2 Stack Memory]]
	- [[#2. Java Memory Areas#2.3 Method Area (Metaspace in Java 8+)|2.3 Method Area (Metaspace in Java 8+)]]
	- [[#2. Java Memory Areas#2.4 PC Register (Program Counter)|2.4 PC Register (Program Counter)]]
	- [[#2. Java Memory Areas#2.5 Native Method Stack|2.5 Native Method Stack]]
- [[#3. Stack vs Heap|3. Stack vs Heap]]
	- [[#3. Stack vs Heap#Code Example|Code Example]]
	- [[#3. Stack vs Heap#Stack vs Heap Comparison Table|Stack vs Heap Comparison Table]]
- [[#4. PermGen vs Metaspace|4. PermGen vs Metaspace]]
	- [[#4. PermGen vs Metaspace#Before Java 8 — PermGen (Permanent Generation)|Before Java 8 — PermGen (Permanent Generation)]]
	- [[#4. PermGen vs Metaspace#After Java 8 — Metaspace|After Java 8 — Metaspace]]
	- [[#4. PermGen vs Metaspace#PermGen vs Metaspace Table|PermGen vs Metaspace Table]]
	- [[#4. PermGen vs Metaspace#Why PermGen Was Removed|Why PermGen Was Removed]]
- [[#5. Young Generation Memory|5. Young Generation Memory]]
	- [[#5. Young Generation Memory#Structure|Structure]]
	- [[#5. Young Generation Memory#Object Movement Lifecycle|Object Movement Lifecycle]]
	- [[#5. Young Generation Memory#Key Facts|Key Facts]]
- [[#6. Garbage Collection (GC)|6. Garbage Collection (GC)]]
	- [[#6. Garbage Collection (GC)#Types of GC Events|Types of GC Events]]
	- [[#6. Garbage Collection (GC)#GC Algorithms|GC Algorithms]]
	- [[#6. Garbage Collection (GC)#Stop-the-World (STW)|Stop-the-World (STW)]]
	- [[#6. Garbage Collection (GC)#GC Reachability|GC Reachability]]
- [[#7. Object Lifecycle in Java|7. Object Lifecycle in Java]]
	- [[#7. Object Lifecycle in Java#finalize() Method|finalize() Method]]
- [[#8. Strong, Weak, Soft & Phantom References|8. Strong, Weak, Soft & Phantom References]]
	- [[#8. Strong, Weak, Soft & Phantom References#Code Examples|Code Examples]]
- [[#9. Memory Leaks in Java|9. Memory Leaks in Java]]
	- [[#9. Memory Leaks in Java#Common Causes & Fixes|Common Causes & Fixes]]
		- [[#Common Causes & Fixes#❌ 1. Static Collections|❌ 1. Static Collections]]
		- [[#Common Causes & Fixes#❌ 2. Unclosed Resources|❌ 2. Unclosed Resources]]
		- [[#Common Causes & Fixes#❌ 3. Event Listener Leaks|❌ 3. Event Listener Leaks]]
		- [[#Common Causes & Fixes#❌ 4. ThreadLocal Misuse|❌ 4. ThreadLocal Misuse]]
		- [[#Common Causes & Fixes#❌ 5. Inner Class Holding Outer Reference|❌ 5. Inner Class Holding Outer Reference]]
- [[#10. OutOfMemoryError Types|10. OutOfMemoryError Types]]
	- [[#10. OutOfMemoryError Types#Summary Table|Summary Table]]
	- [[#10. OutOfMemoryError Types#OOM Examples|OOM Examples]]
- [[#11. StackOverflowError|11. StackOverflowError]]
	- [[#11. StackOverflowError#Fix: Use Iteration or Increase Stack Size|Fix: Use Iteration or Increase Stack Size]]
- [[#12. JVM Tuning Basics|12. JVM Tuning Basics]]
	- [[#12. JVM Tuning Basics#Core JVM Memory Flags|Core JVM Memory Flags]]
	- [[#12. JVM Tuning Basics#Heap Sizing Best Practices|Heap Sizing Best Practices]]
	- [[#12. JVM Tuning Basics#Quick Diagnostic Commands|Quick Diagnostic Commands]]
- [[#13. JVM Memory Diagram|13. JVM Memory Diagram]]
- [[#14. Important Interview Questions|14. Important Interview Questions]]
	- [[#14. Important Interview Questions#❓ Why is String stored in the heap?|❓ Why is String stored in the heap?]]
	- [[#14. Important Interview Questions#❓ Why are local variables thread-safe?|❓ Why are local variables thread-safe?]]
	- [[#14. Important Interview Questions#❓ What is the difference between heap and stack?|❓ What is the difference between heap and stack?]]
	- [[#14. Important Interview Questions#❓ Why was PermGen removed?|❓ Why was PermGen removed?]]
	- [[#14. Important Interview Questions#❓ What causes memory leaks in Java?|❓ What causes memory leaks in Java?]]
	- [[#14. Important Interview Questions#❓ Explain the GC process.|❓ Explain the GC process.]]
	- [[#14. Important Interview Questions#❓ What is a GC Root?|❓ What is a GC Root?]]
	- [[#14. Important Interview Questions#❓ What is the difference between Minor, Major, and Full GC?|❓ What is the difference between Minor, Major, and Full GC?]]
- [[#15. Quick Revision Cheatsheet|15. Quick Revision Cheatsheet]]
	- [[#15. Quick Revision Cheatsheet#One-Line Definitions|One-Line Definitions]]
	- [[#15. Quick Revision Cheatsheet#Key JVM Flags Reference|Key JVM Flags Reference]]
	- [[#15. Quick Revision Cheatsheet#Memory Hierarchy Summary|Memory Hierarchy Summary]]
	- [[#15. Quick Revision Cheatsheet#GC Algorithm Decision Guide|GC Algorithm Decision Guide]]
	- [[#15. Quick Revision Cheatsheet#Object Lifecycle Quick Reference|Object Lifecycle Quick Reference]]
